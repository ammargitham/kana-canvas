        ...
        {letters.map((letter, index) => {
          ...
          return (
            <Link
              ...
              className="border border-neutral-200 bg-neutral-200/50 hover:bg-slate-300/50 transition-colors p-4 text-center rounded flex flex-col items-center gap-2"
            >
